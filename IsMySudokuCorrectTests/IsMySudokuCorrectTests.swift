...
class IsMySudokuCorrectTests: XCTestCase {
    ...
    func testExample() {
        ...
        let result81 = Sudoku.isTrueForAll(mySudoku81, mySudokuSize: 9)
        ...
        let result36 = Sudoku.isTrueForAll(mySudoku36, mySudokuSize: 6)
        ...
        let result36_2 = Sudoku.isTrueForAll(mySudoku36_2, mySudokuSize: 6)
        ...
        let resultMissingInfo = Sudoku.isTrueForAll(mySudokuMissingInfo, mySudokuSize: 6)
